...
$sample = [
    ...
    'items'   => [
        [
            ...
            'desc'       => 'Nắm vững kỹ thuật chơi và hoà âm bộ 7 chuông pha lê theo hệ 7 nốt nhạc, mang lại cảm giác thư giãn sâu cho cơ thể và tâm trí.',
            'time'       => '09:00 – 17:00',
        ...
        [
            ...
            'desc'       => 'Khởi đầu hành trình thư giãn cùng thực hành Reiki. Học cách tự thư giãn và xoa dịu căng thẳng ở mức cơ bản.',
            'time'       => '09:00 – 17:00',
        ...
        [
            'image'      => ['url' => MONA_THEME_PATH_URI . '/assets/images/courses-img-3.png', 'alt' => 'Trải Nghiệm Sound Bath'],
            'term'       => 'Bộ Môn Âm Thanh',
            'level'      => 'Chuyên sâu',
            'format'     => 'Onsite',
            'title'      => 'Trải Nghiệm Sound Bath',
            'desc'       => 'Đào tạo chuyên sâu kỹ năng tổ chức và dẫn dắt các buổi tắm âm thanh thư giãn chuyên nghiệp.',
            'time'       => '09:00 – 17:00',
...
$data = [
    'heading' => get_field('courses_heading', $page_id) ?: 'Đào Tạo Chuyên Sâu',
