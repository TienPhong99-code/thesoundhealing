...
$sample = [
    'heading'  => "Trải Nghiệm Âm Thanh Thư Giãn\nToàn Diện",
    ...
    'items'    => [
        ...
        [
            ...
            'desc'  => 'Đội ngũ giảng viên được đào tạo bài bản về âm thanh thư giãn và thiền định, với nhiều năm kinh nghiệm thực hành.',
        ],
        [
            'title' => 'Công Cụ Âm Thanh Chất Lượng Cao',
            'desc'  => 'Bát hát Tây Tạng, âm thoa và nhạc cụ truyền thống được tuyển chọn kỹ lưỡng từ các nghệ nhân uy tín trên thế giới.',
        ],
        [
            'title' => 'Chương Trình Cá Nhân Hóa',
            'desc'  => 'Mỗi học viên nhận được lộ trình học tập được thiết kế riêng dựa trên nhu cầu, mục tiêu và mong muốn cá nhân.',
        ],
        [
            'title' => 'Cộng Đồng Hỗ Trợ Lâu Dài',
            'desc'  => 'Hành trình thư giãn không kết thúc sau buổi học. Học viên tham gia cộng đồng và được hỗ trợ liên tục qua các buổi chia sẻ định kỳ.',
        ],
    ],
];
