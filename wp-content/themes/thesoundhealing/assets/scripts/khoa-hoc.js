(function ($) {
    ...
    function initDatePicker() {
        ...
        var availDates = (window.khSchedule && Array.isArray(window.khSchedule.availDates) && window.khSchedule.availDates.length)
            ? window.khSchedule.availDates : [];
    ...
    function disableIfExpired() {
        if (!(window.khSchedule && window.khSchedule.isPast)) return;
        var $btn = $('.cf7-khoa-hoc .wpcf7-submit');
